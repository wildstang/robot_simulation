...
/**
 * Handles points on a graph as well as provides interactive viewing of the
 * graph.
 *
...
public class Graph extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener
{
     ...
     *
     * @param _points points to be graphed in the format of _points[point
     * number][0 for x and 1 for y]
     */
    ...
    /**
     * Zooms the graph in and out when user rolls the mouse wheel relative to
